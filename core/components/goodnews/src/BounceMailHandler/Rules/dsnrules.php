...
/**
 * GoodNews BounceMailHandler standard DSN rules set
 ...
 * @return array $result
 */
function dsnRules($dsnMsg, $dsnReport)
{
    ...
    $statusCodes = [
         '5.0.0' => ['bounce_type' => 'hard']  //Address does not exist
        ,'5.1.0' => ['bounce_type' => 'hard']  //Other address status
        ,'5.1.1' => ['bounce_type' => 'hard']  //Bad destination mailbox address
        ,'5.1.2' => ['bounce_type' => 'hard']  //Bad destination system address
        ,'5.1.3' => ['bounce_type' => 'hard']  //Bad destination mailbox address syntax
        ,'5.1.4' => ['bounce_type' => 'hard']  //Destination mailbox address ambiguous
        ,'5.1.5' => ['bounce_type' => 'hard']  //Destination mailbox address valid
        ,'5.1.6' => ['bounce_type' => 'hard']  //Mailbox has moved
        ,'5.1.7' => ['bounce_type' => 'hard']  //Bad sender’s mailbox address syntax
        ,'5.1.8' => ['bounce_type' => 'hard']  //Bad sender’s system address
        ,'5.2.0' => ['bounce_type' => 'soft']  //Other or undefined mailbox status
        ,'5.2.1' => ['bounce_type' => 'soft']  //Mailbox disabled, not accepting messages
        ,'5.2.2' => ['bounce_type' => 'soft']  //Mailbox full
        ,'5.2.3' => ['bounce_type' => 'hard']  //Message length exceeds administrative limit
        ,'5.2.4' => ['bounce_type' => 'hard']  //Mailing list expansion problem
        ,'5.3.0' => ['bounce_type' => 'hard']  //Other or undefined mail system status
        ,'5.3.1' => ['bounce_type' => 'soft']  //Mail system full
        ,'5.3.2' => ['bounce_type' => 'hard']  //System not accepting network messages
        ,'5.3.3' => ['bounce_type' => 'hard']  //System not capable of selected features
        ,'5.3.4' => ['bounce_type' => 'hard']  //Message too big for system
        ,'5.4.0' => ['bounce_type' => 'hard']  //Other or undefined network or routing status
        ,'5.4.1' => ['bounce_type' => 'hard']  //No answer from host
        ,'5.4.2' => ['bounce_type' => 'hard']  //Bad connection
        ,'5.4.3' => ['bounce_type' => 'hard']  //Routing server failure
        ,'5.4.4' => ['bounce_type' => 'hard']  //Unable to route
        ,'5.4.5' => ['bounce_type' => 'soft']  //Network congestion
        ,'5.4.6' => ['bounce_type' => 'hard']  //Routing loop detected
        ,'5.4.7' => ['bounce_type' => 'hard']  //Delivery time expired
        ,'5.5.0' => ['bounce_type' => 'hard']  //Other or undefined protocol status
        ,'5.5.1' => ['bounce_type' => 'hard']  //Invalid command
        ,'5.5.2' => ['bounce_type' => 'hard']  //Syntax error
        ,'5.5.3' => ['bounce_type' => 'soft']  //Too many recipients
        ,'5.5.4' => ['bounce_type' => 'hard']  //Invalid command arguments
        ,'5.5.5' => ['bounce_type' => 'hard']  //Wrong protocol version
        ,'5.6.0' => ['bounce_type' => 'hard']  //Other or undefined media error
        ,'5.6.1' => ['bounce_type' => 'hard']  //Media not supported
        ,'5.6.2' => ['bounce_type' => 'hard']  //Conversion required and prohibited
        ,'5.6.3' => ['bounce_type' => 'hard']  //Conversion required but not supported
        ,'5.6.4' => ['bounce_type' => 'hard']  //Conversion with loss performed
        ,'5.6.5' => ['bounce_type' => 'hard']  //Conversion failed
        ,'5.7.0' => ['bounce_type' => 'hard']  //Other or undefined security status
        ,'5.7.1' => ['bounce_type' => 'hard']  //Delivery not authorized, message refused
        ,'5.7.2' => ['bounce_type' => 'hard']  //Mailing list expansion prohibited
        ,'5.7.3' => ['bounce_type' => 'hard']  //Security conversion required but not possible
        ,'5.7.4' => ['bounce_type' => 'hard']  //Security features not supported
        ,'5.7.5' => ['bounce_type' => 'hard']  //Cryptographic failure
        ,'5.7.6' => ['bounce_type' => 'hard']  //Cryptographic algorithm not supported
        ,'5.7.7' => ['bounce_type' => 'hard']  //Message integrity failure
        ,'9.1.1' => ['bounce_type' => 'hard']  //Hard bounce with no bounce code found
    ];
    ...
    if (preg_match('/Original-Recipient: rfc822;(.*)/i', $dsnReport, $match)) {
        ...
        if (
            isset($email_arr[0]->host) && $email_arr[0]->host != '.SYNTAX-ERROR.' &&
    ...
    // If email still couldn't be extracted try to get from dsn message
    ...
    */
    ...
    recipient's mailbox is full. Create a shorter message body or remove attachments and try
    sending it again.
    sample 2:
    ...
    */
    ...
    /*
    sample:
    Diagnostic-Code: smtp;552 5.2.2 This message is larger than the current system limit
    or the recipient's mailbox is full. Create a shorter message body or remove attachments
    ...
    */
    ...
    /*
    sample:
    Diagnostic-Code: SMTP; 554 delivery error: dd Sorry your message to xxxxx@yourdomain.com cannot
    be delivered. This account has been disabled or discontinued [#102]. - mta173.mail.tpe.domain.com
    */
    ...
    */
    ...
    /*
    sample:
    Diagnostic-Code: SMTP; 550 <xxxxx@yourdomain.com>: Recipient address rejected: Account closed
    due to inactivity. No forwarding information is available.
    */
    ...
    */
    ...
    MIME error: error: UnexpectedBound: part didn't end with expected boundary
    [in multipart message]; EOSToken: EOF; EOSType: EOF
    */
    ...
    */
    ...
    /*
    sample:
    Diagnostic-Code: SMTP; 554 Connection refused(mx). MAIL FROM [xxxxx@yourdomain.com]
    mismatches client IP [111.111.111.000].
    */
    ...
    */
    ...
    /*
    sample:
    Diagnostic-Code: SMTP; 554 Service unavailable; Client host [111.111.111.211] blocked
    using dynablock.domain.com; Your message could not be delivered due to complaints we received
    regarding the IP address you're using or your ISP. See http:// blackholes.domain.com/ Error: WS-02^M
    */
    ...
    */
    ...
    Message blocked by BOX Solutions (www.domain.com) SpamTrap Technology, please contact the
    domain.com site manager for help: (ctlusr8012).^M
    */
    ...
    */
    ...
    of ( *(ca2639) 7|-{%2E* : {2"(%EJ;y} (SBI$#$@<K*:7s1!=l~) matches a profile the Internet
    community may consider spam. Please revise your message before resending.
    */
