 ...
 * @property string $activationEmailTpl The template for the activation email. (default: sample.GoodNewsActivationEmailChunk)
 ...
 * @property string $reSubscriptionEmailTpl The template for the renewal email. (default: sample.GoodNewsReSubscriptionEmailChunk)
