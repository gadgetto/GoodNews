 ...
 */
class GoodNewsStopMailingProcessor extends modProcessor {

    /** @var GoodNewsMailing $goodnewsmailing */
    public $goodnewsmailing;
    ...
    public function process() {
        if (!$this->goodnewsmailing) {
            return $this->failure('GoodNewsMailing class does not exist');
        }
        $this->goodnewsmailing->setIPCstop($this->mailingid);
        return $this->success();
    }
}
return 'GoodNewsStopMailingProcessor';
