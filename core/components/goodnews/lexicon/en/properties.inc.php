...
$_lang['prop_goodnewssubscription.sendsubscriptionemail_desc']      = 'Wether to send the subscriber an email after successfull activation.';
...
$_lang['prop_goodnewsunsubscription.submitvar_desc']                = 'Prüfvariable: Falls leer oder nicht gesetzt, wird das Snippet alle POST-Variablen im Formular verwenden.';
