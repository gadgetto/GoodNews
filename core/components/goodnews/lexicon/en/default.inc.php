...
$_lang['goodnews.subscribers_user_category_filter']                 = 'Filter by Category...';
...
$_lang['goodnews.subscriber_active_filter']                         = 'Activated?';
...
$_lang['goodnews.subscribers_no_category']                          = 'No category assigned';
...
$_lang['goodnews.settings_worker_process_limit_desc']               = 'Defines the maximum count of parallel sending processes to be used. If you move the slider to 1, multiprocessing will be disabled and the default sending process will be used instead.';
$_lang['goodnews.settings_process_max']                             = ' processes max.';
$_lang['goodnews.settings_multiprocessing_disabled']                = 'Multiprocessing disabled';
...
$_lang['goodnews.settings_auto_fix_imagesizes_desc']                = 'Whether or not images which are inserted with a WYSIWYG editor and are adjusted in its dimension, will be automatically converted to their appropriate dimension.';
...
$_lang['goodnews.settings_container_mail_from_desc']                = 'The E-Mail Address used for sending mails and for receiving bounce messages (Non Delivery Notifications).';
$_lang['goodnews.settings_container_mail_from_name']                = 'Sender Name';
$_lang['goodnews.settings_container_mail_from_name_desc']           = 'The Sender Name used for sending mails.';
$_lang['goodnews.settings_container_mail_reply_to']                 = 'Reply-To E-Mail Address';
$_lang['goodnews.settings_container_mail_reply_to_desc']            = 'The E-Mail Address used for receiving answers to mails.';
$_lang['goodnews.settings_container_mail_charset']                  = 'Mail Charset';
$_lang['goodnews.settings_container_mail_charset_desc']             = 'Default charset for emails, e.g., \'iso-8859-1\' or \'utf-8\'';
$_lang['goodnews.settings_container_mail_encoding']                 = 'Mail Encoding';
$_lang['goodnews.settings_container_mail_encoding_desc']            = 'Encoding of the message. Options: "8bit", "7bit", "binary", "base64", and "quoted-printable".';
$_lang['goodnews.settings_container_mail_bouncehandling']           = 'Automatic Bounce Handling';
$_lang['goodnews.settings_container_mail_bouncehandling_desc']      = 'Whether to automatically analyze and handle bounce messages.';
...
$_lang['goodnews.settings_container_smtp_user_desc']                = 'The user to authenticate to SMTP against.';
$_lang['goodnews.settings_container_smtp_pass']                     = 'SMTP Password';
$_lang['goodnews.settings_container_smtp_pass_desc']                = 'The password to authenticate to SMTP against.';
...
$_lang['goodnews.settings_container_smtp_prefix']                   = 'SMTP Connection Prefix';
$_lang['goodnews.settings_container_smtp_prefix_desc']              = 'Sets connection prefix. Options are "", "ssl" or "tls".';
$_lang['goodnews.settings_container_smtp_keepalive']                = 'SMTP Keep-Alive';
$_lang['goodnews.settings_container_smtp_keepalive_desc']           = 'Prevents the SMTP connection from being closed after each mail sending. Not recommended.';
...
$_lang['goodnews.import_subscribers_update_existing']               = 'Update existing subscribers';
$_lang['goodnews.import_subscribers_update_existing_desc']          = 'If activated, already existing subscribers will be updated (Change Fullname, Add Group- and Category assignments). Otherwise they will be skipped';
...
$_lang['goodnews.import_subscribers_log_subscr_imported']           = 'Imported: ';
...
$_lang['setting_goodnews.auto_fix_imagesizes_desc']                 = 'Whether or not images which are inserted with a WYSIWYG editor and are adjusted in its dimension, will be automatically converted to their appropriate dimension.';
...
$_lang['setting_goodnews.auto_cleanup_subscriptions_desc']          = 'Whether or not inactive or never activated Subscriptions, including their corresponding MODX User-Accounts, will be removed automatically. This only concerns MODX User-Accounts which have GoodNews meta-data assigned! MODX User-Accounts which belongs to MODX User-Groups stay untouched!.';
